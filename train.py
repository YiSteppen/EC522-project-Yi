...
if __name__ == '__main__':
    ...
    # Load dataset
    args.path = 'E:\OneDrive\PhDCourses\EC522\Project\LearnedDesignFPM-master\data\training_data_amplitude.mat' 
    dataset = dataloader.dataloader(args.path, args.batch_size, loadBatchFlag=True, device=device)
